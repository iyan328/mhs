                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Jalur Kerjasama <small><?php echo $nama?></small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
							...
							<li class="active">
                                <i class="fa fa-pencil"></i> Jalur Kerjasama
                            </li>
                        </ol>
                    </div>
                </div>
                            ...
                            <table class="table table-bordered table-hover table-striped">
                                ...
                                <tbody>
									...
									?>
											...
											<?php
												include "koneksi.php";
												$nama1 = $data['perusahaan'];
												$sql3 = "SELECT * from mhs WHERE username='$nm'";
												$kueri3 = mysql_query($sql3);
												$data3 = mysql_fetch_array($kueri3);
												$nim = $data3['nim'];
												$sql1 = "SELECT * from magang WHERE nim = '$nim' AND perusahaan = '$nama1'";
												$kueri1 = mysql_query($sql1);
												$data1 = mysql_fetch_array($kueri1);
												$nama2 = $data1['nim'];
												if ($nama2 == "" || $data1['verifikasi']=='Gagal'){
											?>
													<td><a href="../upload-download-files/daftar-kerjasama.php?kode=<?php echo $data['perusahaan']?>">daftar</td>
											<?php
																}
												else {
											?>
